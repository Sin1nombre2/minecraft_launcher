...
ventana.resizable(False, False) # Para que no se pueda cambiar el tamaño d la ventana
...
# Ver todas las versiones que tengo instaladas y mostrarlas en un despegable
...
versiones_menu_despegable = ctk.CTkOptionMenu(ventana, variable=vers, values=versiones_instaladas_lista)
versiones_menu_despegable.configure()
...
def menu():
    ...
    versiones_menu_despegable.place(x=20, y=450)
